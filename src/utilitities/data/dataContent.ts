...
export const headerDataPT: headerContent = {
  ...
  about:
    "Tenho 25 anos, nascido em Boa Vista - Roraima (Brasil). Possuo bastante interesse em inovação e é isso que me motiva a cada dia tentar algo novo. Em meio a isso me identifiquei bastante com o a idealização e desenvolvimento de sistemas, o qual decidi seguir como uma meta de vida",
  language: "Língua",
};

export const headerDataEN: headerContent = {
